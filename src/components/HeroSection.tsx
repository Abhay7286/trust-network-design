        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-400 mb-12 leading-relaxed max-w-3xl mx-auto">
              Your comprehensive directory for finding vetted cybersecurity professionals and service providers. 
              Explore trusted companies specializing in penetration testing, OSINT, risk management, and security consulting.
            </p>
            
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
              <Link to="/providers">
                <Button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-6 text-lg font-semibold rounded-lg shadow-lg hover:shadow-blue-500/25 transition-all duration-300">
                  Find Providers
                </Button>
              </Link>
              <Button
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div className="text-center">
                ...
                <p className="text-gray-400">Carefully curated cybersecurity service providers</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">Multiple Services</h3>
                <p className="text-gray-400">Comprehensive range of security specializations</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-400">Connect with reputable security professionals</p>
              </div>
            </div>
          </div>
        </div>
